...
// Sticky side navigation, styled like the blog TOC. Same behaviour as the 2025 recap's nav,
// but takes its sections as a prop instead of importing one page's content.
